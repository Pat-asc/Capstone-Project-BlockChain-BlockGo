...
import { clearSessionRecovery, useRecoveredState } from '../../utils/sessionRecovery';
...
const clearLocalStorageKeysByPrefix = (prefix) => {
...
const RegistrarGradesView = ({
    ...
    useEffect(() => {
        const applyEncodingPeriod = (value) => {
            ...
            const semesterLabel = parsed?.semester || '2nd Semester';
            const schoolYearLabel = parsed?.schoolYear || '';
            setActiveSemester(schoolYearLabel ? `${schoolYearLabel} • ${semesterLabel}` : semesterLabel);
        };
    ...
    const handleResetEncodingSeason = useCallback(async () => {
        try {
            ...
            clearLocalStorageKeysByPrefix('facultySectionStatuses:');
            clearLocalStorageKeysByPrefix('facultySectionGrades:');
            clearLocalStorageKeysByPrefix('facultyBulkUploads:');
