      ...
      <div className="flex w-full items-center justify-between px-6 py-4">
        <div className="flex items-center gap-3">
          ...
          <div className="leading-tight">
            ...
            <h1 className="text-xl font-bold text-white">Welcome, {registrarData?.name || "Registrar"}</h1>
          </div>
        </div>
        ...
        <div className="flex items-center gap-3">
          <div className="hidden rounded-xl bg-white/10 px-4 py-2 text-right md:block">
            ...
            <p className="text-sm font-semibold text-white">{registrarData?.schoolYear || "2025-2026"}</p>
          </div>
          <div className="hidden rounded-xl bg-white/10 px-4 py-2 text-right md:block">
            <p className="text-xs text-white/70">Semester</p>
            <p className="text-sm font-semibold text-white">{registrarData?.semester || "2nd Semester"}</p>
          </div>
